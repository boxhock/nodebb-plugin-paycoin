...
console.log('1. Load Client Scripts Loading!');

(function() {

"use strict";
var 	db = require('./nodebb').db,
		notifications = require('./nodebb').notifications,
		nconf = require('nconf');

//Start Up
console.log('2. Load Client Scripts Loading!');



// Montior a Paycoin Address for Transactions
 
var walletAddress = $.get(RELATIVE_PATH + '/api/crypto', {}, function(addressData) {

	// I am unsure if we have a working API yet
